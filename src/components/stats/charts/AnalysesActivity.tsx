...
const AnalysesActivity = ({ analyses, lang }: PropsFromRedux) => {
 ...
 useEffect(() => {
  const Chart = () => {
   ...
   setChartData({
    ...
    datasets: [
     {
      label: lang.messages.find((m) => m.code.match(String(76)))?.message,
      data: ty,
 ...
 return (
  <div className="AnalysesActivity row">
   {!analyses.loading ? (
    <>
     <h4>{lang.messages.find((m) => m.code.match(String(77)))?.message}:</h4>
